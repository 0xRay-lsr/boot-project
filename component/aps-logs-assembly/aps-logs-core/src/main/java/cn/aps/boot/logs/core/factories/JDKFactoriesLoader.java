package cn.aps.boot.logs.core.factories;
...
public class JDKFactoriesLoader {
    private static final Logger LOGGER = Logger.getLogger(JDKFactoriesLoader.class.getName());
    ...
    private static <T> Map<String, T> getFactories(Class<T> factoryClass) {
        ...
        if (factoryInstances == null) {
            synchronized (JDKFactoriesLoader.class) {
